  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "glow-fire-i": "var(--glow-fire-intense)",
        "glow-gold":   "var(--glow-gold)",
        "glow-wine":   "var(--glow-wine)",
      },
      backgroundImage: {
        "fire":  "linear-gradient(135deg, hsl(var(--fire-bright)), hsl(var(--fire-core)), hsl(var(--fire-deep)))",
        "fire-h":"linear-gradient(90deg,  hsl(var(--fire-bright)), hsl(var(--fire-deep)))",
        "gold":  "linear-gradient(135deg, hsl(var(--gold-light)),  hsl(var(--gold-main)), hsl(var(--gold-dark)))",
        "brand": "linear-gradient(135deg, hsl(var(--fire-bright)), hsl(var(--wine-deep)))",
      },
      borderRadius: {
        lg: "var(--radius)",
