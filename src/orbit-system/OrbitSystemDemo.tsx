...
export default function OrbitSystemDemo() {
  ...
  /**
   * אפשר לבדוק כמה דפים מתוך אותו דמו.
   */
  ...
  return (
    ...
    >
      ...
      {/* תוכן דמה לבדיקת גלילה */}
      <main className="relative z-10">
        {page.orbit.items.map((item) => (
          <section
            key={item.id}
            id={item.targetSectionId}
            className="scroll-mt-32 mx-auto min-h-[88svh] max-w-[1200px] px-4 py-20 sm:px-6 lg:px-10"
          >
            <div
            ...
            >
              ...
              <h2 className="text-3xl font-bold">כותרת תוכן לדוגמה {item.label}</h2>
