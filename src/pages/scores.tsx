                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <button
                        ...
                        className="inline-flex h-12 items-center justify-center rounded-2xl bg-primary px-7 text-sm font-semibold text-primary-foreground transition hover:-translate-y-[1px] md:text-base"
                      >
                        להזמנה אישית
                      </button>
                      ...
                      <button
                        ...
                        className="inline-flex h-12 items-center justify-center rounded-2xl border border-border bg-card/70 px-7 text-sm font-semibold transition hover:bg-card md:text-base"
                      >
                        לעיון במאגר
                      </button>
                    </div>
            ...
            <AppearOnScroll delay={50}>
              <section>
                ...
                <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
                  {SERVICES.map(({ key, title, text, Icon }) => (
                    <div
                      key={key}
                ...
                <div className="rounded-[2rem] bg-card/72 px-6 py-7 shadow-soft ring-1 ring-border backdrop-blur-sm md:px-8 md:py-8">
                  ...
                  <div className="mt-6 space-y-5">
                    {[
                      ...
                      "אני כותבת / מעבדת לפי הכלי, הרמה והסולם הרצויים",
                  ...
                  >
                    ...
                    {submitted && (
                      <div className="rounded-2xl bg-primary/10 px-4 py-3 text-sm text-foreground ring-1 ring-primary/15">
                        הבקשה עדיין לא נשלחה — הטופס הוא דמו בלבד, ולכן הפרטים נשארים על המסך ולא נשמרים בשרת.
                      </div>
                    )}
                  </form>
                </div>
